...
%\showgrid % show numbered baseline grid on every page 
...
\institute{\inits{F.} \snm{Author} % Initials & Surname
	   ...
	   % 
         \and
           \inits{S.} \snm{Author}
           \at 
           \orgdiv{Department of Mathematics and Statistic},
	   \orgname{Cornell University},
           \city{Ithaca},
           \postcode{14853}
	   \state{NY}, 
	   \cny{USA}
	  ...
	  \orgdiv{D-MATH}, 
	  \orgname{ETH Z\"urich},
	  \street{R\"amistrasse 101}, 
	  \postcode{8092}
	  \city{Z\"urich},
	  \cny{Switzerland}\\
          \email{sauthor@example.ch}}
...
%\bibliographystyle{spr-mp}          % numbered citations
%\bibliographystyle{spr-mp-nameyear}% nameyear citations
%\bibliography{biblio}% your BibTeX data base
%\nocite{*}
