...
The following files are part of the macro package
  ...
  svfist.clo    Base definitions for the FIST journal
  template.tex  A fill-in form for a standard article with usage comments

In due course:
  svjourn3-fist.tex   Example of an article
  svjourn3-fist.pdf   The file svjourn3-fist.pdf contains a ready to print version
